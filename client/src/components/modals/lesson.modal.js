    ...
    return (
        <>
            <div 
                ...
                className="flex flex-col absolute overflow-y-scroll overflow-x-hidden inset-0 bg-black bg-opacity-30 backdrop-blur-sm justify-center items-center ">
                    <div className=" bg-white w-2/4 mt-6 px-6 py-3 rounded-lg">
                        <div className="flex flex-inline justify-between modal-header rounded text-center">
