...
export default function Footer() {
  ...
  return (
    <>
    <footer className="flex flex-row flex-wrap  items-center justify-around bg-gray-600  ">
        <div className="w-full container md:p-5 p-5 md:flex items-center justify-between">
